## Welcome to upload CSV data to oracle database 

upload CSV data to oracle database  is a B2B SaaS application that was generated using [ROQ.ai](https://roq.ai/)
